...
#ifndef GEOMETRY_ALGOS_ANGLE2_H_
#define GEOMETRY_ALGOS_ANGLE2_H_
...
inline void angle_between_face_normals(
		const MAP& map,
		const typename MAP::template VertexAttributeHandler<VEC3_T>& position,
		typename MAP::template EdgeAttributeHandler<typename VEC3_T::Scalar>& angles)
{
